...
<div class="container mt-5">
    ...
    <div class="tab-content mt-3">
        ...
        <div class="tab-pane fade show active" id="all">
            @include('user.components.product_section', ['menus' => $menus])
        </div>

        <!-- Pending Payment Orders -->
        <div class="tab-pane fade" id="nike">
            @include('user.components.product_section', ['menus' => $menunike])
        </div>

        <!-- Shipping Orders -->
        <div class="tab-pane fade" id="adidas">
            @include('user.components.product_section', ['menus' => $menuadidas])
        </div>

        <!-- Awaiting Delivery Orders -->
        <div class="tab-pane fade" id="mcqueen">
            @include('user.components.product_section', ['menus' => $menuMcqueen])
        ...
        <div class="tab-pane fade" id="puma">
            @include('user.components.product_section', ['menus' => $menuPuma])

        </div>

        <!-- Return/Refund Orders -->
        <div class="tab-pane fade" id="mlb">
            @include('user.components.product_section', ['menus' => $menuMLB])
        </div>
    </div>
</div>
<style>
