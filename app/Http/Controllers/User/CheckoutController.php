...
class CheckoutController extends Controller
{
    ...
    // {   
    //     $addressItemsfirst = Address::where('user_id', Auth::id())->first();
    ...
    //     $orderItems = []; // Initialize order items array
    
    //     // Retrieve products based on selected items
    ...
    //         'title'=>"order",
    //     ],compact('orderItems','addressItems','addressItemsfirst'));
    // }
